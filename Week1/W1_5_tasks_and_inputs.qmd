...
3. Download the wildboar movement data here: `r download_url("wildschwein_BE.csv","datasets")` (right click "Save target as..")
...
In the next task, we would like to add a background map to our `mcp` object. Download the file here: `r download_url("pk100_BE.tif","datasets")` 
