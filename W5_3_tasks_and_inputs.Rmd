...
```{r, code =  mydecrypt("15_Week5/task_1.R",".passphrase"), opts.label="solution_hideOutput"}
```
...
```{r, code =  mydecrypt("15_Week5/task_2.R",".passphrase"), opts.label="solution_hideOutput"}
```
...
```{r, code =  mydecrypt("15_Week5/task_3.R",".passphrase"), opts.label="solution_showOutput"}
```
...
```{r, code =  mydecrypt("15_Week5/task_4.R",".passphrase"), opts.label="solution_showOutput"}
```
...
```{r, code =  mydecrypt("15_Week5/task_5.R",".passphrase"), opts.label="solution_showOutput"}
