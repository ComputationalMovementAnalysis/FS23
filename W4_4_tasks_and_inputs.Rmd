...
```{r, code =  mydecrypt("14_Week4/task_1.R",".passphrase"), opts.label="solution_hideOutput"}
```
...
```{r, code =  mydecrypt("14_Week4/task_2.R",".passphrase"), opts.label="solution_showOutput"}
```
...
```{r, code =  mydecrypt("14_Week4/task_3.R",".passphrase"), opts.label="solution_showOutput"}
```
...
```{r, code =  mydecrypt("14_Week4/task_4.R",".passphrase"), opts.label="solution_showOutput"}
```
...
```{r, code =  mydecrypt("14_Week4/task_5.R",".passphrase"), opts.label="solution_showOutput"}
```
...
```{r, code =  mydecrypt("14_Week4/task_6.R",".passphrase"), opts.label="solution_hideOutput"}
```
